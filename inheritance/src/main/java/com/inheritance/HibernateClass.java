    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                sessionFactory=new MetadataSources(ssr).addAnnotatedClass(Employee.class).addAnnotatedClass(P_Employee.class).addAnnotatedClass(T_Employee.class).getMetadataBuilder().build().buildSessionFactory();
