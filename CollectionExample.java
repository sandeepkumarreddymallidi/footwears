...
public class CollectionExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(hs.floor(37));//it will return less than or equal to the given element,or null if there is no such element
		System.out.println(hs.ceiling(34));//it will return greater than or equal to the given element,or null if there is no such element
		...
		System.out.println(hs.subSet(35,true,100,true));//it will return the sorted set from the fromelement to toelement if we keep them as a true
